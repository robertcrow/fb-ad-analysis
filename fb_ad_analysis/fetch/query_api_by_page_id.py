...
def query_api_by_page_id(token, phrase, ad_time_start="2019-08-06T00:00:00+0200", ad_time_end="2019-12-12T00:00:00+0200"):
    
    response = requests.get("https://graph.facebook.com/v7.0/ads_archive?"
                         ...
                         "&ad_reached_countries=GB&active_status=all&ad_type=political_and_issue_ads&country=GB" +
